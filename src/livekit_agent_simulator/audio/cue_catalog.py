...
BUILTIN_ALIASES: dict[str, str] = {
    ...
    # Hamming classes: correction / backchannel / escalate (+ soft / long variants)
    ...
    "voice.yeah": "backchannel_yeah_en.wav",
    ...
    "voice.barge_correction": "barge_correction_en.wav",
    "voice.escalate": "barge_escalate_en.wav",
    "voice.barge_escalate": "barge_escalate_en.wav",
    "voice.human": "barge_escalate_en.wav",
    "voice.soft": "barge_soft_en.wav",
    "voice.barge_soft": "barge_soft_en.wav",
    ...
    "voice.uhhuh_vi": "backchannel_vi.wav",
